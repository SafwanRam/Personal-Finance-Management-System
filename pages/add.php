...
<?php if($a == "edit") : ?>
  ...
  <form action="" method="post" id="form-add" class="flex">
    <h3 class="form-title">Enter today's Income</h3>
    ...
    <div class="nominal">
      ...
      <input type="text" name="nominal" id="nominal" required value="Rs. <?=number_format($data["nominal"],0,',','.'); ?>"/>
    </div>
...
<?php else : ?>
  <form action="" method="post" id="form-add" class="flex">
    ...
    <div class="savings">
      <input type="checkbox" name="savings" id="savings" Checked>
