      ...
      <ul>
        <li class="Fieldset">
          <div class="fileds">
            ...
            <input value="<?= $user['name']; ?>" type="text" name="names" id="name" class="before-Fs" required />
          </div>
        </li>
        <li class="Fieldset">
          <div class="fileds">
            <h3 class="Fs-H"><span>Contact</span></h3>
            <input value="<?= $user['contact']; ?>" type="text" name="contact" id="contact" class="before-Fs" required  />
          </div>
        </li>
        <li class="Fieldset">
          <div class="fileds">
            <h3 class="Fs-H"><span>Email</span></h3>
            <input value="<?= $user['email']; ?>" type="email" name="email" id="email" class="before-Fs" required  />
          </div>
        </li>
        <li class="Fieldset">
          <div class="fileds">
            <h3 class="Fs-H"><span>Location</span></h3>
            <input value="<?= $user['location']; ?>" type="text" name="location" id="location" class="before-Fs" required  />
          </div>
        </li>
        <!--<li class="Fieldset">
          <div class="fileds">
            <h3 class="Fs-H"><span>Instansi</span></h3>
            <input value="<?= $user['Instansi']; ?>" type="text" name="instansi" id="instansi" class="before-Fs" required  />
          </div>
        </li>
        <li class="Fieldset">
          <div class="fileds">
            <h3 class="Fs-H"><span>Master key</span></h3>
            <input value="Can't be changed" type="text" name="password" id="password" class="before-Fs" required  />
          </div>
        </li>-->
      </ul>
      <button type="submit" name="updateProfile" class="btn btn-success buttonSubmit">Submit</button>
    </form>
  </div><!--
