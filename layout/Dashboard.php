...
<div class="box-container flex">
   <div class="container flex shadow" style="--color-thames: #e74a3b">
      <h5>Spending (monthly)</h5>
      <div class="box-desk flex">
         <span>Rs. <?= $balanceExpenses; ?></span>
   ...
   <div class="container flex shadow" style="--color-thames: #1cc88a">
      <h5>INCOME</h5>
      <div class="box-desk flex">
         <span>Rs. <?= $financialExpenses; ?></span>
...
<div class="recent mt">
   <div class="transaction shadow">
      <div class="card-header flex">
         <h6 class="m-0 font-weight-bold text-primary">Income (<?= date("F  Y"); ?>)</h6>
      </div>
      <div class="contains">
         <?php $i = 1; ?>
         <?php foreach ($result as $row) : ?>
            <div class="flex ddd a">
               <span><?= $i; ?>.&nbsp;</span>
               <p><?= $row["activities"]; ?> for Rs. <?= toCurrency($row["nominal"], 0); ?></p>
            </div>
            <?php $i++ ?>
         <?php endforeach ?>
      </div>
   ...
   <div class="addmony shadow">
      <div class="card-header flex">
         <h6 class="m-0 font-weight-bold text-primary">Spending (<?= date("F  Y"); ?>)</h6>
      </div>
      <div class="contains">
         ...
         <?php foreach ($resultWallet as $row) : ?>
            ...
            <div class="flex ddd">
               <span><?= $i; ?>.&nbsp;</span>
               <p><?php echo ("Treasurer added a Spending of Rs. " . $balance); ?></p>
            </div>
            <?php $i++ ?>
         <?php endforeach ?>
      </div>
